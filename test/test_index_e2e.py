...
class E2ETests(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Chrome(executable_path=r'/Users/erikavacacela/Documents/Programs/chromedriver')
    ...
    def test_page_has_button_for_subnitting_text(self):
        submit_button = self._find('find-button')
        self.assertIsNotNone(submit_button)

    def test_submitting_sentense_create_table(self):
        input_element = self._find('input-text')
        submit_button = self._find('find-button')
